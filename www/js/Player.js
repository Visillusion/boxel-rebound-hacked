(function (window) {
	...
	this.hack = function(){
	if(this.jumphack){
this.jumphack = false;}else{
this.jumphack = true;}
}
	this.spikehack = function(){
	if(this.spikehack){
this.spikehack= false;}else{
this.spikehack= true;}
}
this.checkpointhack = function(){
for (var i=0; i < this.hitBox.length-2; i++){
this.spawnX = this.hitBox[i].x - this.x; 
                    this.spawnY = this.hitBox[i].y+2; this.newSpawn = true; 
